...
public:
	...
	Color4f(const Color &color = Color::Black);
...
Vec3	convertVec3(const Color4f &c);
Vec4	convertVec4(const Color4f &c);
Color   convertColor(const Vec3 &v, const float &a = 1.0f);
Color   convertColor(const Vec4 &v);
Color   convertColor(const Color4f &c);
